...
exports.default = function (tsconfigPath, files, excludes) {
    var tsConfig = loadTsConfig(tsconfigPath, files);
    return analyzer_1.default(parser_1.default(path_1.dirname(tsconfigPath), tsConfig.files, tsConfig.baseUrl, excludes));
};
